...
public abstract class GwtRpcDataSource extends DataSource {
    ...
    protected Object transformRequest(DSRequest request) {
        ...
        switch (request.getOperationType()) {
            ...
            case REMOVE:
                ...
                break;
            default:
                throw new IllegalStateException("The operation type '" + request.getOperationType() + "' is not implemented.");
        }
     ...
     *
     * @param requestId <code>String</code> extracted from
     *                  <code>DSRequest.getRequestId ()</code>.
     * @param request   <code>DSRequest</code> being processed.
     * @param response  <code>DSResponse</code>. <code>setData (list)</code> should be
